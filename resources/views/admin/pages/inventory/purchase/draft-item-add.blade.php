                                    ...
                                    <div class="col-12 col-sm-12">
                                        <div class="form-group">
                                            <div class="icheck-success d-inline">
                                                <input type="checkbox" id="checkboxSuccess1" name="is_draft">
                                                <label for="checkboxSuccess1">Check to save as draft
                                                </label>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    $(document).ready(function() {
        ...
        purchaseDatapopulate('amount','tax_amount','shipping_charge');
